...
namespace Modelo
{
    public abstract class Usuario : IValidable
    {
        ...
        public void Validacion() // Utilizo expresiones regulares para validar que lo ingresado es correcto.
        {
            ValidarNombre();
            ValidarApellido();
            ValidarEmail();
        ...
        #endregion
        public abstract string ObtenerRol(); // Creo este metodo para luego utilizarlo para obtener facilmente el rol de cada usuario en el Front.
    }
}
